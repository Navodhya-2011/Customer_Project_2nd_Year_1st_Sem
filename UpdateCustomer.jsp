		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Update Customer Details</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-12">
					<div class="wrap d-md-flex">
						<div class="text-wrap p-4 p-lg-5 d-flex img" style="background-image: url(images/bg.jpg);">
							<div class="text w-100">
								<h2 class="mb-4">Update Your Details</h2>
							</div>
			      </div>
						<div class="login-wrap p-4 p-md-5">
			      	<div class="row justify-content-center py-md-5">
			      		<div class="col-lg-9">
									<form action="update" class="signup-form" method="post">
                                        <div class="row">
											<div class="col-md-6">
                                        ...
                                        <input type="password" name="pass" value="<%= password %>" class="form-control">
											...
											<div class="col-md-12">
												<div class="form-group">
						            	<button type="submit" class="default-button">Update Customer Details</button>
						            </div>
											</div>
										</div>
